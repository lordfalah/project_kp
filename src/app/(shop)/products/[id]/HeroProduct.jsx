      ...
      <Container className="px-4 sm:px-0">
        <main className="flex flex-col lg:flex-row lg:gap-x-10 xl:gap-x-14 2xl:gap-x-24 gap-y-5">
          <div className="space-y-3 block md:hidden">
            <h1 className="text-5xl font-semibold">Chair Thatty</h1>
            <div className="flex justify-between items-center">
              <h4 className="text-xl font-normal">
                Rp {formatRupiah(12000000)}
              </h4>
              <button
                // onClick={addToCart}
          ...
          >
            ...
            >
              <img
                ...
                src="https://files.edgestore.dev/v1qu2d14bd2h2lnw/publicFiles/_public/6cb57ee2-97c9-45c6-b583-a6a38978b41f.png"
                alt=""
              />
            </div>
            ...
            "
            >
              {tempData?.imgUrls.map((image, idx) => (
                <div
          ...
          <article className="my-0 md:mb-8 md:mt-14 lg:my-0">
            <div className="space-y-1 hidden md:block">
              <h1 className="text-5xl font-semibold">{tempData?.title}</h1>
              <div className="flex justify-between items-center">
                <h4 className="text-xl font-normal">
                  Rp {formatRupiah(tempData?.price)}
                </h4>
                <button
                  onClick={addToCart}
                  onTouchEnd={clearTouch}
            ...
            <div
              className="space-y-5"
              dangerouslySetInnerHTML={{ __html: tempData?.description }}
            />
          </article>
        </main>
      </Container>
